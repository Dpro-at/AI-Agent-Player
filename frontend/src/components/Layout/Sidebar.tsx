...
const navigationItems = [
  ...
  { path: '/dashboard/training-lab', label: 'Training Lab', icon: '🧪', locked: false, hidden: false },
  { path: '/dashboard/tasks', label: 'Tasks', icon: '✅', locked: false, hidden: false },
  { path: '/dashboard/form-builder', label: 'Form Builder', icon: '📝', locked: false, hidden: false },
